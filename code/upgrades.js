...
const raindropUpgrades = {
    worth: new Upgrade("raindrop", "worth", "Raindrop Worth", level => level == 45 ? "hello elmendaL45(.2)" : ("Raindrops are worth more. Current worth: +" + level), level => 10 * Math.pow(level + 1, 1.08), level => level, 0),
